...
# Start spark Session
spark = SparkSession.builder.appName("correlation_Middle_East_and_North_Africa").getOrCreate()
...
reordered_df = reordered_df.filter(col("Region") == "Middle East and North Africa")
...
correlation_spark_df.coalesce(1).write.mode("overwrite").option("header", "true").csv("project/final/q3_correlation/Middle_East_and_North_Africa")