...
# Start spark Session
spark = SparkSession.builder.appName("correlation_North America and Caribbean").getOrCreate()
...
reordered_df = reordered_df.filter(col("Region") == "North America and Caribbean")
...
correlation_spark_df.coalesce(1).write.mode("overwrite").option("header", "true").csv("project/final/q3_correlation/North_America_and_Caribbean")