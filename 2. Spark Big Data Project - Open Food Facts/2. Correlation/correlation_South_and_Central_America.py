...
# Start spark Session
spark = SparkSession.builder.appName("correlation_South and Central America").getOrCreate()
...
reordered_df = reordered_df.filter(col("Region") == "South and Central America")
...
correlation_spark_df.coalesce(1).write.mode("overwrite").option("header", "true").csv("project/final/q3_correlation/South_and_Central_America")