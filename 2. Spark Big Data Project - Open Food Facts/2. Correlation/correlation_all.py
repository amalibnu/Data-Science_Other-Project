...
# Start spark Session
spark = SparkSession.builder.appName("correlation_all").getOrCreate()
...
correlation_spark_df.coalesce(1).write.mode("overwrite").option("header", "true").csv("project/final/q3_correlation/all")
